...
const styles = StyleSheet.create({
  ...
  playerInitialSmallCompact: {
    fontSize: 14,
    fontWeight: '700',
    color: '#1E293B',
  },
  playerNamePremiumCompact: {
    fontSize: 14,
    fontWeight: '700',
    color: '#06392e',
  },
  ...
  // --- REDESIGNED TEAM SELECTION STYLES ---
  selectionHeaderPremium: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 20,
    paddingVertical: 16,
  ...
  selectionTitlePremium: {
    fontSize: 18,
    fontWeight: '900',
    color: '#06392e',
    letterSpacing: -0.5,
  },
  selectionSubtitlePremium: {
    fontSize: 12,
    color: '#94A3B8',
    fontWeight: '600',
    marginTop: 2,
  ...
  continueBtnTextPremium: {
    color: '#FFFFFF',
    fontSize: 16,
    fontWeight: '800',
    letterSpacing: 0.5,
  },
  // --- REDESIGNED TEAM PICKER STYLES ---
  pickerViewContainer: {
    flex: 1,
    backgroundColor: '#FFFFFF',
  },
  ...
  pickerTabIndicator: {
    ...
    right: 16,
    height: 3,
    backgroundColor: '#01b854', // Using green for consistency
